...
//  frameRate(200);
  ...
  String portName = Serial.list()[serialIndex]; // This gets the first port on your computer ...
...
public void onNewHand(SimpleOpenNI curContext,int handId,PVector pos)
{
  ...
  myPort.write('S'); // This will start the LED process...
...
public void onLostHand(SimpleOpenNI curContext,int handId)
{
  ...
  myPort.write('N'); // This will end the LED process...
}
...
public void keyPressed()
{
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#F0F0F0", "demo3" });
  }
}
